        ...
        <div className="mx-auto w-full max-w-[640px] text-center">
          ...
          <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center md:mt-10">
            <BlobButton
              ...
              className="[--blob-button-color:#25D366] inline-flex items-center justify-center gap-2 rounded-full px-8 py-3.5 font-body text-[16px] font-semibold"
            >
            ...
            <BlobButton
              href="/"
              className="[--blob-button-color:#E3CC9D] inline-flex items-center justify-center gap-2 rounded-full px-8 py-3.5 font-body text-[16px] font-semibold"
            >
