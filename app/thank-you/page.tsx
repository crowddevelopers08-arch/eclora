    ...
    <main className="flex min-h-screen flex-col bg-white">
      ...
      <header className="w-full border-b border-[#E3CC9D] bg-white/95 backdrop-blur-sm">
        <div className="mx-auto flex max-w-[1280px] items-center justify-between px-4 py-4 sm:px-6 md:px-[80px] md:py-5">
          ...
          <BlobButton
            href={`tel:${SITE.phone}`}
            className="inline-flex items-center gap-2 rounded-full px-4 py-2 font-body text-[15px] font-semibold sm:px-5 sm:py-2.5 sm:text-[16px]"
          >
      ...
      <section className="flex flex-1 flex-col items-center justify-center px-4 py-10 sm:px-6 md:px-[80px] lg:py-14">
        <div className="mx-auto w-full max-w-[640px] text-center">
          ...
          <p className="mt-3 font-label text-[15px] font-semibold uppercase tracking-[0.16em] text-[#4E5426]/70">
          ...
          <div className="mt-10 rounded-[1.25rem] border border-[#E3CC9D] bg-white p-6 text-left md:mt-12 md:p-8">
            <h2 className="mb-5 font-heading text-[14px] font-bold uppercase tracking-[0.18em] text-[#4E5426]">
              What Happens Next
            </h2>
            <ul className="space-y-5">
              {NEXT_STEPS.map(({ icon, title, desc }) => (
                <li key={title} className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-body text-[16px] font-semibold leading-[1.4] text-[#1E2115] md:text-[16px]">
                      {title}
                    </p>
                    <p className="mt-0.5 font-body text-[16px] leading-[1.7] text-[#5F6352]">
                      {desc}
                    </p>
                  </div>
                </li>
          ...
          <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center md:mt-10">
            <BlobButton
              ...
              className="[--blob-button-color:#25D366] flex w-full items-center justify-center gap-2 rounded-full px-8 py-3.5 font-body text-[16px] font-semibold sm:w-auto"
            >
            ...
            <BlobButton
              href="/"
              className="[--blob-button-color:#E3CC9D] flex w-full items-center justify-center gap-2 rounded-full px-8 py-3.5 font-body text-[16px] font-semibold sm:w-auto"
            >
          ...
          <p className="mt-10 font-body text-[16px] text-[#8A8D80]">
      ...
      <footer className="border-t border-[#E3CC9D] px-4 py-6 text-center sm:px-6 md:px-[80px]">
        <p className="font-body text-[15px] text-[#8A8D80]">
