    ...
    <main className="flex min-h-screen flex-col bg-white">
      ...
      <header className="w-full border-b border-[#E3CC9D] bg-white/95 backdrop-blur-sm">
        <div className="mx-auto flex max-w-[1280px] items-center justify-between px-4 py-4 sm:px-6 md:px-[80px] md:py-5">
          ...
          <BlobButton
            href={`tel:${SITE.phone}`}
            className="inline-flex items-center gap-2 rounded-full px-4 py-2 font-body text-[13px] font-semibold sm:px-5 sm:py-2.5 sm:text-[14px]"
          >
        ...
        <div className="mx-auto w-full max-w-[640px] text-center">
          ...
          <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center md:mt-10">
            <BlobButton
              ...
              className="[--blob-button-color:#25D366] flex w-full items-center justify-center gap-2 rounded-full px-8 py-3.5 font-body text-[14px] font-semibold sm:w-auto"
            >
            ...
            <BlobButton
              href="/"
              className="[--blob-button-color:#E3CC9D] flex w-full items-center justify-center gap-2 rounded-full px-8 py-3.5 font-body text-[14px] font-semibold sm:w-auto"
            >
